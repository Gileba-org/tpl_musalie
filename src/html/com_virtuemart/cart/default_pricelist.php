...
if (empty($this->cart->cartPrices['salesPriceShipment'])) {
	$this->cart->cartPrices['salesPriceShipment'] = "0,00";
}
if (empty($this->cart->cartPrices['salesPricePayment'])) {
	$this->cart->cartPrices['salesPricePayment'] = "0,00";
}
?>
...
<tr class="sectiontableentry1">
	<td colspan="3" style="text-align: right;"><?php echo vmText::_ ('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_PRICES_TOTAL'); ?></td>
	<?php if (VmConfig::get ('show_tax')) { ?>
...
<tr class="sectiontableentry<?php echo $i ?>">
	<td colspan="3" style="text-align: right;"><?php echo vmText::_($rule['calc_name']) ?> </td>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td style="text-align: right;"></td>
	<?php } ?>
	...
	<td colspan="3" style="align:left;vertical-align:top;">
		...
		if (!empty($this->layoutName) and $this->layoutName == $this->cart->layout) {
			if (VmConfig::get('oncheckout_opc', 0)) {
				...
				echo JHtml::_('link', JRoute::_('index.php?option=com_virtuemart&view=cart&task=edit_shipment', $this->useXHTML, $this->useSSL), $this->select_shipment_text, 'class="button"');
			}
		} else {
	...
	<td colspan="3" style="align:left;vertical-align:top;">
		...
		if (!empty($this->layoutName) && $this->layoutName == $this->cart->layout) {
			if (VmConfig::get('oncheckout_opc', 0)) {
				...
				echo JHtml::_('link', JRoute::_('index.php?option=com_virtuemart&view=cart&task=editpayment', $this->useXHTML, $this->useSSL), $this->select_payment_text, 'class="button"');
			}
		} else {
...
<tr class="sectiontableentry2">
	<td colspan="3" style="text-align: right;"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
	<?php if (VmConfig::get ('show_tax')) { ?>
...
?>
<tr class="sectiontableentry2">
	<td colspan="3" style="text-align: right;"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL_PAYMENT') ?>:</td>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td style="text-align: right;">&nbsp;</td>
	<?php } ?>
	<td style="text-align: right;">&nbsp;</td>
