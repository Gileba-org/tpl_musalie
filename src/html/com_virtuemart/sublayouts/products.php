	...
	<div class="product vm-col<?php echo " vm-col-" . $products_per_row . $show_vertical_separator; ?>">
		<div class="spacer product-container" data-vm="product-container">
			...
			<div class="vm-product-rating-container">
				<?php
    echo shopFunctionsF::renderVmSubLayout("rating", ["showRating" => $showRating, "product" => $product]);
    if (VmConfig::get("display_stock", 1)) { ?>
					<span class="vmicon vm2-<?php echo $product->stock->stock_level; ?>" title="<?php echo $product->stock
	->stock_tip; ?>"></span>
				<?php }
    echo shopFunctionsF::renderVmSubLayout("stockhandle", ["product" => $product]);
    ?>
			</div>
      ...
      if (!empty($product->product_s_desc)) {
		...
		?>
			<div class="vm3pr-<?php echo $rowsHeight[$row]["price"]; ?>"> <?php echo shopFunctionsF::renderVmSubLayout("prices", [
	"product" => $product,
	"currency" => $currency,
]); ?>
				<div class="clear"></div>
		...
		echo JHtml::link($link . $ItemidStr, vmText::_("COM_VIRTUEMART_PRODUCT_DETAILS"), [
			...
			<div class="vm3pr-<?php echo $rowsHeight[$row]["customfields"]; ?>"> <?php echo shopFunctionsF::renderVmSubLayout(
	"addtocart",
	["product" => $product, "rowHeights" => $rowsHeight[$row], "position" => ["ontop", "addtocart"]]
); ?>
			</div>
